    ...
    render() {
        return (
            <div className="App">
                ...
                <div>
                    <button onClick={this.generateThings}>Generate All The Things</button>
                </div>
                ...
                <div>
                    <HttpMethodInput httpMethod={this.state.httpMethod}
                                     onChange={e => this.handleChange('httpMethod', e)}/>
                </div>
            </div>
        );
    }
